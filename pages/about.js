...
export default function About() {
  return (
    <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-5">
            <div>
              <ul>
                <li>In the past </li>
                <li>
                  - an overview of your company = walking into your office
                </li>
                <li>
                  - solving something = going to someone and asking for a
                  solution
                </li>
            ...
            <div>
              <ul>
                <li>Now, with remote work</li>
                <li>
                  - an overview of the company = some names on Slack and tiny
                  faces on Zoom
                </li>
                <li>
      ...
      <section className="grid grid-cols-1 gap-6 justify-center items-center px-10 py-0 lg:px-96 lg:py-20 border-t">
